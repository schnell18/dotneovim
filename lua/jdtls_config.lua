...
function M.setup()
  ...
  require('jdtls').start_or_attach({
    cmd = {
      'java-lsp.sh', os.getenv('HOME') .. '/.local/jdtls/' .. vim.fn.fnamemodify(vim.fn.getcwd(), ':p:h:t')
    },
    root_dir = require('jdtls.setup').find_root({'Dockerfile', 'pom.xml'})
  })
  ...
  -- Few language servers support these three
